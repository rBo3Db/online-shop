...
var assignInWith = __webpack_require__(40),
    attempt = __webpack_require__(70),
    baseValues = __webpack_require__(73),
    customDefaultsAssignIn = __webpack_require__(74),
    escapeStringChar = __webpack_require__(75),
    isError = __webpack_require__(25),
    isIterateeCall = __webpack_require__(19),
    keys = __webpack_require__(28),
    reInterpolate = __webpack_require__(29),
...
/* harmony default export */ __webpack_exports__["a"] = (MainModel);
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _categoriesObject__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var _presenter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(0);
/* harmony import */ var _models_main_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);
/* harmony import */ var _views_categories_view__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(38);
...
function CategoriesPresenter(history) {
    _presenter__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].apply(this, arguments);
    this.history = history;
    this.view = new _views_categories_view__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"]();
    this.model = new _models_main_model__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"]();
    this.element = document.getElementsByClassName('main')[0];
}

CategoriesPresenter.prototype = Object.create(_presenter__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].prototype);
...
CategoriesPresenter.prototype.init = function () {
    ...
    for (i = 0; i < this.model.getData(_categoriesObject__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"]).length; i++) {

        this.renderPlus(this.view.getTemplate(this.model.getData(_categoriesObject__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"]), i));
    };
    this.getButtons();
    this.bindEvents();
};
...
/* harmony default export */ __webpack_exports__["a"] = (CategoriesPresenter);
...
/* harmony import */ var _presenter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(0);
/* harmony import */ var _models_main_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);
/* harmony import */ var _views_goods_in_list_view__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(39);
...
function goodsInListPresenter(history, cart) {
    _presenter__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].apply(this, arguments);
    this.history = history;
    this.view = new _views_goods_in_list_view__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"]();
    this.model = new _models_main_model__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"]();
...
goodsInListPresenter.prototype = Object.create(_presenter__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].prototype);
...
goodsInListPresenter.prototype.init = function () {
    ...
    for (j = 0; j < this.model.getData(_categoriesObject__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"][i].goods).length; j++) {

        this.renderPlus(this.view.getTemplate(this.model.getData(_categoriesObject__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"]), i, j));
    };
    this.getButtons();
    this.bindEvents();
};
...
/* harmony default export */ __webpack_exports__["a"] = (goodsInListPresenter);
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(31)))
...
// CONCATENATED MODULE: ./tpl/categories.tpl.js
var categories = `
...
CategoriesView.prototype.getTemplate = function (products, i) {
    ...
    var templateForInsert = template_default()(categories_tpl)({ products, i });
    return templateForInsert;
};

/* harmony default export */ var categories_view = __webpack_exports__["a"] = (CategoriesView);
...
// CONCATENATED MODULE: ./tpl/goods-in-list.tpl.js
...
`;
/* harmony default export */ var goods_in_list_tpl = (goodsInListTpl);
// EXTERNAL MODULE: ./node_modules/lodash/template.js
var template = __webpack_require__(1);
var template_default = /*#__PURE__*/__webpack_require__.n(template);

// CONCATENATED MODULE: ./src/views/goods-in-list-view.js
...
goodsInListView.prototype.getTemplate = function (products, i, j) {
    ...
    var templateForInsert = template_default()(goods_in_list_tpl)({ products, i, j });
    return templateForInsert;
};

/* harmony default export */ var goods_in_list_view = __webpack_exports__["a"] = (goodsInListView);
...
var escape = __webpack_require__(79),
    reEscape = __webpack_require__(84),
    reEvaluate = __webpack_require__(85),
    reInterpolate = __webpack_require__(29);
...
var escapeHtmlChar = __webpack_require__(80),
    toString = __webpack_require__(30);
...
var basePropertyOf = __webpack_require__(81);
...
// EXTERNAL MODULE: ./src/presenters/presenter.js
...
var header = template_default()(`
    ...
    `)();
/* harmony default export */ var header_tpl = (header);
// document.getElementsByClassName('header')[0].innerHTML = header;
// CONCATENATED MODULE: ./src/views/header-view.js
...
/* harmony default export */ var header_view = (HeaderView);
// CONCATENATED MODULE: ./src/presenters/header-presenter.js
...
function HeaderPresenter(history) {
    presenter["a" /* default */].apply(this, arguments);
    this.history = history;
...
HeaderPresenter.prototype = Object.create(presenter["a" /* default */].prototype);
...
/* harmony default export */ var header_presenter = (HeaderPresenter);
// CONCATENATED MODULE: ./tpl/popup.tpl.js

// function loadPopup(){
var popup = template_default()(`
...
// }
// loadPopup()
/* harmony default export */ var popup_tpl = (popup);
// CONCATENATED MODULE: ./src/views/popup-view.js
...
/* harmony default export */ var popup_view = (PopupView);
// CONCATENATED MODULE: ./src/presenters/popup-presenter.js
// import products from '../categoriesObject';
...
PopupPresenter.prototype = Object.create(presenter["a" /* default */].prototype);
...
/* harmony default export */ var popup_presenter = (PopupPresenter);
// EXTERNAL MODULE: ./src/presenters/categories-presenter.js
var categories_presenter = __webpack_require__(34);

// EXTERNAL MODULE: ./src/categoriesObject.js
var categoriesObject = __webpack_require__(2);

// EXTERNAL MODULE: ./src/models/main-model.js
var main_model = __webpack_require__(3);

// CONCATENATED MODULE: ./tpl/left-side-bar.tpl.js
...
/* harmony default export */ var left_side_bar_tpl = (tplOfLeftBar);
// CONCATENATED MODULE: ./src/views/left-side-bar-view.js


function LeftSideBarView() {}

LeftSideBarView.prototype.getTemplate = function (products, i) {
    var templateForInsert = template_default()(left_side_bar_tpl)({ products, i });
    return templateForInsert;
};

/* harmony default export */ var left_side_bar_view = (LeftSideBarView);
// CONCATENATED MODULE: ./src/presenters/left-side-bar-presenter.js
...
function LeftSideBarPresenter(history) {
    presenter["a" /* default */].apply(this, arguments);
    this.history = history;
    this.view = new left_side_bar_view();
    this.model = new main_model["a" /* default */]();
    this.element = document.getElementById('widgetConteiner');
}

LeftSideBarPresenter.prototype = Object.create(presenter["a" /* default */].prototype);
...
LeftSideBarPresenter.prototype.init = function () {
    ...
    this.render(this.view.getTemplate(this.model.getData(categoriesObject["a" /* default */]), i));
    // }
    // this.getButtons();
    // this.bindEvents();
};
...
/* harmony default export */ var left_side_bar_presenter = (LeftSideBarPresenter);
// EXTERNAL MODULE: ./src/presenters/goods-in-list-presenter.js
var goods_in_list_presenter = __webpack_require__(35);

// CONCATENATED MODULE: ./tpl/item-card.tpl.js
const itemTpl = `
    <main class="main">
        <div class='slider'>
    ...
    `;
/* harmony default export */ var item_card_tpl = (itemTpl);
// CONCATENATED MODULE: ./src/views/item-card-view.js


function itemCardView() {}

itemCardView.prototype.getTemplate = function (products, i, j) {
    var templateForInsert = template_default()(item_card_tpl)({ products, i, j });
    return templateForInsert;
};

/* harmony default export */ var item_card_view = (itemCardView);
// CONCATENATED MODULE: ./src/presenters/item-card-presenter.js
...
function ItemViewPresenter(history, cart) {
    presenter["a" /* default */].apply(this, arguments);
    this.history = history;
    this.view = new item_card_view();
    this.model = new main_model["a" /* default */]();
    this.element = document.getElementsByClassName('main')[0];
    this.cart = cart;
}

ItemViewPresenter.prototype = Object.create(presenter["a" /* default */].prototype);
...
ItemViewPresenter.prototype.init = function () {
    ...
    this.renderPlus(this.view.getTemplate(this.model.getData(categoriesObject["a" /* default */]), this.i, this.j));
...
ItemViewPresenter.prototype.handleButtonClick = function () {
    this.cart.add(this.model.getCartModel(this.model.getData(categoriesObject["a" /* default */]), this.i, this.j));
    console.log('Click to button #');
};
...
/* harmony default export */ var item_card_presenter = (ItemViewPresenter);
// CONCATENATED MODULE: ./tpl/cart.tpl.js
...
/* harmony default export */ var cart_tpl = (cartTpl);
// CONCATENATED MODULE: ./src/views/cart-view.js
...
CartView.prototype.getTemplate = function (products, i) {
    ...
    var templateForInsert = template_default()(cart_tpl)({ products, i });
    return templateForInsert;
};

/* harmony default export */ var cart_view = (CartView);
// CONCATENATED MODULE: ./src/presenters/cart-presenter.js
// import products from '../categoriesObject';
...
cartPresenter.prototype = Object.create(presenter["a" /* default */].prototype);
...
/* harmony default export */ var cart_presenter = (cartPresenter);
...
Router.prototype.dispatch = function (history, cart) {
    ...
    if (history.location.pathname === '/index') {
        this.clean();
        this.currentPreseners = [new header_presenter(history), new popup_presenter(history), new categories_presenter["a" /* default */](history)];
        return this.currentPreseners;
    }
    if (history.location.pathname === '/goods') {
        this.clean();

        this.currentPreseners = [new header_presenter(history), new popup_presenter(history), new left_side_bar_presenter(history), new goods_in_list_presenter["a" /* default */](history, cart)];
        return this.currentPreseners;
    }
    if (history.location.pathname === '/good') {
        this.clean();

        this.currentPreseners = [new header_presenter(history), new popup_presenter(history), new item_card_presenter(history, cart)];
        return this.currentPreseners;
    }
    if (history.location.pathname === '/cart') {
        this.clean();

        this.currentPreseners = [new header_presenter(history), new popup_presenter(history), new cart_presenter(history, cart)];
        return this.currentPreseners;
    }
    // if (history.location.pathname === '/goods') {
    //     this.clean();
...
App.prototype.renderPage = function (history, cart) {
    ...
    if (this.blocks) {
        forEach_default()(this.blocks, function (block) {
            block.init();
        });
    }
};
...
var createBrowserHistory = __webpack_require__(37);
...
// CONCATENATED MODULE: ./services/cartService.js
...
const src_history = createBrowserHistory_default()();
const src_cart = new Cart();
var src_app = new app();

src_app.renderPage(src_history, src_cart);

src_history.listen((location, action) => {
    src_app.renderPage(src_history, src_cart);
});
